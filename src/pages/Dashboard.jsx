...
const Dashboard = () => {
    ...
    const [stats, setStats] = useState({ dailyRevenue: 0, orderCount: 0, lowStockCount: 0, pendingOrders: 0 });
    const [weekStats, setWeekStats] = useState({ revenue: 0, lastWeekRevenue: 0 });
